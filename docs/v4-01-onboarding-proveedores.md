# Onboarding de proveedores (KYC + OAuth)
```
+-------------+      +---------------+      +----------------+
...
## Formulario KYC y validaciones
1. Haz clic en **Formulario KYC y validaciones — paso 1**.
    - Captura sugerida: evidencia del resultado (paso 1).
    - Comprobación: estado/valor/elemento actualizado correctamente.
2. Haz clic en **Formulario KYC y validaciones — paso 2**.
    - Captura sugerida: evidencia del resultado (paso 2).
    - Comprobación: estado/valor/elemento actualizado correctamente.
3. Haz clic en **Formulario KYC y validaciones — paso 3**.
    - Captura sugerida: evidencia del resultado (paso 3).
    - Comprobación: estado/valor/elemento actualizado correctamente.
4. Haz clic en **Formulario KYC y validaciones — paso 4**.
    - Captura sugerida: evidencia del resultado (paso 4).
    - Comprobación: estado/valor/elemento actualizado correctamente.
5. Haz clic en **Formulario KYC y validaciones — paso 5**.
    - Captura sugerida: evidencia del resultado (paso 5).
    - Comprobación: estado/valor/elemento actualizado correctamente.
6. Haz clic en **Formulario KYC y validaciones — paso 6**.
    - Captura sugerida: evidencia del resultado (paso 6).
    - Comprobación: estado/valor/elemento actualizado correctamente.
7. Haz clic en **Formulario KYC y validaciones — paso 7**.
    - Captura sugerida: evidencia del resultado (paso 7).
    - Comprobación: estado/valor/elemento actualizado correctamente.
8. Haz clic en **Formulario KYC y validaciones — paso 8**.
    - Captura sugerida: evidencia del resultado (paso 8).
    - Comprobación: estado/valor/elemento actualizado correctamente.
9. Haz clic en **Formulario KYC y validaciones — paso 9**.
    - Captura sugerida: evidencia del resultado (paso 9).
    - Comprobación: estado/valor/elemento actualizado correctamente.
10. Haz clic en **Formulario KYC y validaciones — paso 10**.
    - Captura sugerida: evidencia del resultado (paso 10).
    - Comprobación: estado/valor/elemento actualizado correctamente.
11. Haz clic en **Formulario KYC y validaciones — paso 11**.
    - Captura sugerida: evidencia del resultado (paso 11).
    - Comprobación: estado/valor/elemento actualizado correctamente.
12. Haz clic en **Formulario KYC y validaciones — paso 12**.
    - Captura sugerida: evidencia del resultado (paso 12).
    - Comprobación: estado/valor/elemento actualizado correctamente.
13. Haz clic en **Formulario KYC y validaciones — paso 13**.
    - Captura sugerida: evidencia del resultado (paso 13).
    - Comprobación: estado/valor/elemento actualizado correctamente.
14. Haz clic en **Formulario KYC y validaciones — paso 14**.
    - Captura sugerida: evidencia del resultado (paso 14).
    - Comprobación: estado/valor/elemento actualizado correctamente.
15. Haz clic en **Formulario KYC y validaciones — paso 15**.
    - Captura sugerida: evidencia del resultado (paso 15).
    - Comprobación: estado/valor/elemento actualizado correctamente.
16. Haz clic en **Formulario KYC y validaciones — paso 16**.
    - Captura sugerida: evidencia del resultado (paso 16).
    - Comprobación: estado/valor/elemento actualizado correctamente.
17. Haz clic en **Formulario KYC y validaciones — paso 17**.
    - Captura sugerida: evidencia del resultado (paso 17).
    - Comprobación: estado/valor/elemento actualizado correctamente.
18. Haz clic en **Formulario KYC y validaciones — paso 18**.
    - Captura sugerida: evidencia del resultado (paso 18).
    - Comprobación: estado/valor/elemento actualizado correctamente.
19. Haz clic en **Formulario KYC y validaciones — paso 19**.
    - Captura sugerida: evidencia del resultado (paso 19).
    - Comprobación: estado/valor/elemento actualizado correctamente.
20. Haz clic en **Formulario KYC y validaciones — paso 20**.
    - Captura sugerida: evidencia del resultado (paso 20).
    - Comprobación: estado/valor/elemento actualizado correctamente.
21. Haz clic en **Formulario KYC y validaciones — paso 21**.
    - Captura sugerida: evidencia del resultado (paso 21).
    - Comprobación: estado/valor/elemento actualizado correctamente.
22. Haz clic en **Formulario KYC y validaciones — paso 22**.
    - Captura sugerida: evidencia del resultado (paso 22).
    - Comprobación: estado/valor/elemento actualizado correctamente.
23. Haz clic en **Formulario KYC y validaciones — paso 23**.
    - Captura sugerida: evidencia del resultado (paso 23).
    - Comprobación: estado/valor/elemento actualizado correctamente.
24. Haz clic en **Formulario KYC y validaciones — paso 24**.
    - Captura sugerida: evidencia del resultado (paso 24).
    - Comprobación: estado/valor/elemento actualizado correctamente.
25. Haz clic en **Formulario KYC y validaciones — paso 25**.
    - Captura sugerida: evidencia del resultado (paso 25).
    - Comprobación: estado/valor/elemento actualizado correctamente.
26. Haz clic en **Formulario KYC y validaciones — paso 26**.
    - Captura sugerida: evidencia del resultado (paso 26).
    - Comprobación: estado/valor/elemento actualizado correctamente.
27. Haz clic en **Formulario KYC y validaciones — paso 27**.
    - Captura sugerida: evidencia del resultado (paso 27).
    - Comprobación: estado/valor/elemento actualizado correctamente.
28. Haz clic en **Formulario KYC y validaciones — paso 28**.
    - Captura sugerida: evidencia del resultado (paso 28).
    - Comprobación: estado/valor/elemento actualizado correctamente.
29. Haz clic en **Formulario KYC y validaciones — paso 29**.
    - Captura sugerida: evidencia del resultado (paso 29).
    - Comprobación: estado/valor/elemento actualizado correctamente.
30. Haz clic en **Formulario KYC y validaciones — paso 30**.
    - Captura sugerida: evidencia del resultado (paso 30).
    - Comprobación: estado/valor/elemento actualizado correctamente.
31. Haz clic en **Formulario KYC y validaciones — paso 31**.
    - Captura sugerida: evidencia del resultado (paso 31).
    - Comprobación: estado/valor/elemento actualizado correctamente.
32. Haz clic en **Formulario KYC y validaciones — paso 32**.
    - Captura sugerida: evidencia del resultado (paso 32).
    - Comprobación: estado/valor/elemento actualizado correctamente.
33. Haz clic en **Formulario KYC y validaciones — paso 33**.
    - Captura sugerida: evidencia del resultado (paso 33).
    - Comprobación: estado/valor/elemento actualizado correctamente.
34. Haz clic en **Formulario KYC y validaciones — paso 34**.
    - Captura sugerida: evidencia del resultado (paso 34).
    - Comprobación: estado/valor/elemento actualizado correctamente.
35. Haz clic en **Formulario KYC y validaciones — paso 35**.
    - Captura sugerida: evidencia del resultado (paso 35).
    - Comprobación: estado/valor/elemento actualizado correctamente.
36. Haz clic en **Formulario KYC y validaciones — paso 36**.
    - Captura sugerida: evidencia del resultado (paso 36).
    - Comprobación: estado/valor/elemento actualizado correctamente.
37. Haz clic en **Formulario KYC y validaciones — paso 37**.
    - Captura sugerida: evidencia del resultado (paso 37).
    - Comprobación: estado/valor/elemento actualizado correctamente.
38. Haz clic en **Formulario KYC y validaciones — paso 38**.
    - Captura sugerida: evidencia del resultado (paso 38).
    - Comprobación: estado/valor/elemento actualizado correctamente.
39. Haz clic en **Formulario KYC y validaciones — paso 39**.
    - Captura sugerida: evidencia del resultado (paso 39).
    - Comprobación: estado/valor/elemento actualizado correctamente.
40. Haz clic en **Formulario KYC y validaciones — paso 40**.
    - Captura sugerida: evidencia del resultado (paso 40).
    - Comprobación: estado/valor/elemento actualizado correctamente.
41. Haz clic en **Formulario KYC y validaciones — paso 41**.
    - Captura sugerida: evidencia del resultado (paso 41).
    - Comprobación: estado/valor/elemento actualizado correctamente.
42. Haz clic en **Formulario KYC y validaciones — paso 42**.
    - Captura sugerida: evidencia del resultado (paso 42).
    - Comprobación: estado/valor/elemento actualizado correctamente.
43. Haz clic en **Formulario KYC y validaciones — paso 43**.
    - Captura sugerida: evidencia del resultado (paso 43).
    - Comprobación: estado/valor/elemento actualizado correctamente.
44. Haz clic en **Formulario KYC y validaciones — paso 44**.
    - Captura sugerida: evidencia del resultado (paso 44).
    - Comprobación: estado/valor/elemento actualizado correctamente.
45. Haz clic en **Formulario KYC y validaciones — paso 45**.
    - Captura sugerida: evidencia del resultado (paso 45).
    - Comprobación: estado/valor/elemento actualizado correctamente.
46. Haz clic en **Formulario KYC y validaciones — paso 46**.
    - Captura sugerida: evidencia del resultado (paso 46).
    - Comprobación: estado/valor/elemento actualizado correctamente.
47. Haz clic en **Formulario KYC y validaciones — paso 47**.
    - Captura sugerida: evidencia del resultado (paso 47).
    - Comprobación: estado/valor/elemento actualizado correctamente.
48. Haz clic en **Formulario KYC y validaciones — paso 48**.
    - Captura sugerida: evidencia del resultado (paso 48).
    - Comprobación: estado/valor/elemento actualizado correctamente.
49. Haz clic en **Formulario KYC y validaciones — paso 49**.
    - Captura sugerida: evidencia del resultado (paso 49).
    - Comprobación: estado/valor/elemento actualizado correctamente.
50. Haz clic en **Formulario KYC y validaciones — paso 50**.
    - Captura sugerida: evidencia del resultado (paso 50).
    - Comprobación: estado/valor/elemento actualizado correctamente.
51. Haz clic en **Formulario KYC y validaciones — paso 51**.
    - Captura sugerida: evidencia del resultado (paso 51).
    - Comprobación: estado/valor/elemento actualizado correctamente.
52. Haz clic en **Formulario KYC y validaciones — paso 52**.
    - Captura sugerida: evidencia del resultado (paso 52).
    - Comprobación: estado/valor/elemento actualizado correctamente.
53. Haz clic en **Formulario KYC y validaciones — paso 53**.
    - Captura sugerida: evidencia del resultado (paso 53).
    - Comprobación: estado/valor/elemento actualizado correctamente.
54. Haz clic en **Formulario KYC y validaciones — paso 54**.
    - Captura sugerida: evidencia del resultado (paso 54).
    - Comprobación: estado/valor/elemento actualizado correctamente.
55. Haz clic en **Formulario KYC y validaciones — paso 55**.
    - Captura sugerida: evidencia del resultado (paso 55).
    - Comprobación: estado/valor/elemento actualizado correctamente.
56. Haz clic en **Formulario KYC y validaciones — paso 56**.
    - Captura sugerida: evidencia del resultado (paso 56).
    - Comprobación: estado/valor/elemento actualizado correctamente.
57. Haz clic en **Formulario KYC y validaciones — paso 57**.
    - Captura sugerida: evidencia del resultado (paso 57).
    - Comprobación: estado/valor/elemento actualizado correctamente.
58. Haz clic en **Formulario KYC y validaciones — paso 58**.
    - Captura sugerida: evidencia del resultado (paso 58).
    - Comprobación: estado/valor/elemento actualizado correctamente.
59. Haz clic en **Formulario KYC y validaciones — paso 59**.
    - Captura sugerida: evidencia del resultado (paso 59).
    - Comprobación: estado/valor/elemento actualizado correctamente.
60. Haz clic en **Formulario KYC y validaciones — paso 60**.
    - Captura sugerida: evidencia del resultado (paso 60).
    - Comprobación: estado/valor/elemento actualizado correctamente.
## Conexión OAuth del proveedor de pagos
1. Haz clic en **Conexión OAuth del proveedor de pagos — paso 1**.
    - Captura sugerida: evidencia del resultado (paso 1).
    - Comprobación: estado/valor/elemento actualizado correctamente.
2. Haz clic en **Conexión OAuth del proveedor de pagos — paso 2**.
    - Captura sugerida: evidencia del resultado (paso 2).
    - Comprobación: estado/valor/elemento actualizado correctamente.
3. Haz clic en **Conexión OAuth del proveedor de pagos — paso 3**.
    - Captura sugerida: evidencia del resultado (paso 3).
    - Comprobación: estado/valor/elemento actualizado correctamente.
4. Haz clic en **Conexión OAuth del proveedor de pagos — paso 4**.
    - Captura sugerida: evidencia del resultado (paso 4).
    - Comprobación: estado/valor/elemento actualizado correctamente.
5. Haz clic en **Conexión OAuth del proveedor de pagos — paso 5**.
    - Captura sugerida: evidencia del resultado (paso 5).
    - Comprobación: estado/valor/elemento actualizado correctamente.
6. Haz clic en **Conexión OAuth del proveedor de pagos — paso 6**.
    - Captura sugerida: evidencia del resultado (paso 6).
    - Comprobación: estado/valor/elemento actualizado correctamente.
7. Haz clic en **Conexión OAuth del proveedor de pagos — paso 7**.
    - Captura sugerida: evidencia del resultado (paso 7).
    - Comprobación: estado/valor/elemento actualizado correctamente.
8. Haz clic en **Conexión OAuth del proveedor de pagos — paso 8**.
    - Captura sugerida: evidencia del resultado (paso 8).
    - Comprobación: estado/valor/elemento actualizado correctamente.
9. Haz clic en **Conexión OAuth del proveedor de pagos — paso 9**.
    - Captura sugerida: evidencia del resultado (paso 9).
    - Comprobación: estado/valor/elemento actualizado correctamente.
10. Haz clic en **Conexión OAuth del proveedor de pagos — paso 10**.
    - Captura sugerida: evidencia del resultado (paso 10).
    - Comprobación: estado/valor/elemento actualizado correctamente.
11. Haz clic en **Conexión OAuth del proveedor de pagos — paso 11**.
    - Captura sugerida: evidencia del resultado (paso 11).
    - Comprobación: estado/valor/elemento actualizado correctamente.
12. Haz clic en **Conexión OAuth del proveedor de pagos — paso 12**.
    - Captura sugerida: evidencia del resultado (paso 12).
    - Comprobación: estado/valor/elemento actualizado correctamente.
13. Haz clic en **Conexión OAuth del proveedor de pagos — paso 13**.
    - Captura sugerida: evidencia del resultado (paso 13).
    - Comprobación: estado/valor/elemento actualizado correctamente.
14. Haz clic en **Conexión OAuth del proveedor de pagos — paso 14**.
    - Captura sugerida: evidencia del resultado (paso 14).
    - Comprobación: estado/valor/elemento actualizado correctamente.
15. Haz clic en **Conexión OAuth del proveedor de pagos — paso 15**.
    - Captura sugerida: evidencia del resultado (paso 15).
    - Comprobación: estado/valor/elemento actualizado correctamente.
16. Haz clic en **Conexión OAuth del proveedor de pagos — paso 16**.
    - Captura sugerida: evidencia del resultado (paso 16).
    - Comprobación: estado/valor/elemento actualizado correctamente.
17. Haz clic en **Conexión OAuth del proveedor de pagos — paso 17**.
    - Captura sugerida: evidencia del resultado (paso 17).
    - Comprobación: estado/valor/elemento actualizado correctamente.
18. Haz clic en **Conexión OAuth del proveedor de pagos — paso 18**.
    - Captura sugerida: evidencia del resultado (paso 18).
    - Comprobación: estado/valor/elemento actualizado correctamente.
19. Haz clic en **Conexión OAuth del proveedor de pagos — paso 19**.
    - Captura sugerida: evidencia del resultado (paso 19).
    - Comprobación: estado/valor/elemento actualizado correctamente.
20. Haz clic en **Conexión OAuth del proveedor de pagos — paso 20**.
    - Captura sugerida: evidencia del resultado (paso 20).
    - Comprobación: estado/valor/elemento actualizado correctamente.
21. Haz clic en **Conexión OAuth del proveedor de pagos — paso 21**.
    - Captura sugerida: evidencia del resultado (paso 21).
    - Comprobación: estado/valor/elemento actualizado correctamente.
22. Haz clic en **Conexión OAuth del proveedor de pagos — paso 22**.
    - Captura sugerida: evidencia del resultado (paso 22).
    - Comprobación: estado/valor/elemento actualizado correctamente.
23. Haz clic en **Conexión OAuth del proveedor de pagos — paso 23**.
    - Captura sugerida: evidencia del resultado (paso 23).
    - Comprobación: estado/valor/elemento actualizado correctamente.
24. Haz clic en **Conexión OAuth del proveedor de pagos — paso 24**.
    - Captura sugerida: evidencia del resultado (paso 24).
    - Comprobación: estado/valor/elemento actualizado correctamente.
25. Haz clic en **Conexión OAuth del proveedor de pagos — paso 25**.
    - Captura sugerida: evidencia del resultado (paso 25).
    - Comprobación: estado/valor/elemento actualizado correctamente.
26. Haz clic en **Conexión OAuth del proveedor de pagos — paso 26**.
    - Captura sugerida: evidencia del resultado (paso 26).
    - Comprobación: estado/valor/elemento actualizado correctamente.
27. Haz clic en **Conexión OAuth del proveedor de pagos — paso 27**.
    - Captura sugerida: evidencia del resultado (paso 27).
    - Comprobación: estado/valor/elemento actualizado correctamente.
28. Haz clic en **Conexión OAuth del proveedor de pagos — paso 28**.
    - Captura sugerida: evidencia del resultado (paso 28).
    - Comprobación: estado/valor/elemento actualizado correctamente.
29. Haz clic en **Conexión OAuth del proveedor de pagos — paso 29**.
    - Captura sugerida: evidencia del resultado (paso 29).
    - Comprobación: estado/valor/elemento actualizado correctamente.
30. Haz clic en **Conexión OAuth del proveedor de pagos — paso 30**.
    - Captura sugerida: evidencia del resultado (paso 30).
    - Comprobación: estado/valor/elemento actualizado correctamente.
31. Haz clic en **Conexión OAuth del proveedor de pagos — paso 31**.
    - Captura sugerida: evidencia del resultado (paso 31).
    - Comprobación: estado/valor/elemento actualizado correctamente.
32. Haz clic en **Conexión OAuth del proveedor de pagos — paso 32**.
    - Captura sugerida: evidencia del resultado (paso 32).
    - Comprobación: estado/valor/elemento actualizado correctamente.
33. Haz clic en **Conexión OAuth del proveedor de pagos — paso 33**.
    - Captura sugerida: evidencia del resultado (paso 33).
    - Comprobación: estado/valor/elemento actualizado correctamente.
34. Haz clic en **Conexión OAuth del proveedor de pagos — paso 34**.
    - Captura sugerida: evidencia del resultado (paso 34).
    - Comprobación: estado/valor/elemento actualizado correctamente.
35. Haz clic en **Conexión OAuth del proveedor de pagos — paso 35**.
    - Captura sugerida: evidencia del resultado (paso 35).
    - Comprobación: estado/valor/elemento actualizado correctamente.
36. Haz clic en **Conexión OAuth del proveedor de pagos — paso 36**.
    - Captura sugerida: evidencia del resultado (paso 36).
    - Comprobación: estado/valor/elemento actualizado correctamente.
37. Haz clic en **Conexión OAuth del proveedor de pagos — paso 37**.
    - Captura sugerida: evidencia del resultado (paso 37).
    - Comprobación: estado/valor/elemento actualizado correctamente.
38. Haz clic en **Conexión OAuth del proveedor de pagos — paso 38**.
    - Captura sugerida: evidencia del resultado (paso 38).
    - Comprobación: estado/valor/elemento actualizado correctamente.
39. Haz clic en **Conexión OAuth del proveedor de pagos — paso 39**.
    - Captura sugerida: evidencia del resultado (paso 39).
    - Comprobación: estado/valor/elemento actualizado correctamente.
40. Haz clic en **Conexión OAuth del proveedor de pagos — paso 40**.
    - Captura sugerida: evidencia del resultado (paso 40).
    - Comprobación: estado/valor/elemento actualizado correctamente.
...
| r161c1 | r161c2 | r161c3 | r161c4 | r161c5 | r161c6 |
| r162c1 | r162c2 | r162c3 | r162c4 | r162c5 | r162c6 |
| r163c1 | r163c2 | r163c3 | r163c4 | r163c5 | r163c6 |
| r164c1 | r164c2 | r164c3 | r164c4 | r164c5 | r164c6 |
| r165c1 | r165c2 | r165c3 | r165c4 | r165c5 | r165c6 |
| r166c1 | r166c2 | r166c3 | r166c4 | r166c5 | r166c6 |
| r167c1 | r167c2 | r167c3 | r167c4 | r167c5 | r167c6 |
| r168c1 | r168c2 | r168c3 | r168c4 | r168c5 | r168c6 |
| r169c1 | r169c2 | r169c3 | r169c4 | r169c5 | r169c6 |
| r170c1 | r170c2 | r170c3 | r170c4 | r170c5 | r170c6 |
| r171c1 | r171c2 | r171c3 | r171c4 | r171c5 | r171c6 |
| r172c1 | r172c2 | r172c3 | r172c4 | r172c5 | r172c6 |
| r173c1 | r173c2 | r173c3 | r173c4 | r173c5 | r173c6 |
| r174c1 | r174c2 | r174c3 | r174c4 | r174c5 | r174c6 |
| r175c1 | r175c2 | r175c3 | r175c4 | r175c5 | r175c6 |
| r176c1 | r176c2 | r176c3 | r176c4 | r176c5 | r176c6 |
| r177c1 | r177c2 | r177c3 | r177c4 | r177c5 | r177c6 |
| r178c1 | r178c2 | r178c3 | r178c4 | r178c5 | r178c6 |
| r179c1 | r179c2 | r179c3 | r179c4 | r179c5 | r179c6 |
| r180c1 | r180c2 | r180c3 | r180c4 | r180c5 | r180c6 |
