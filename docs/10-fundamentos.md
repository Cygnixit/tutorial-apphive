...
1. Haz clic en **Crear Page paso 1** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 1.

2. Haz clic en **Crear Page paso 2** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 2.

3. Haz clic en **Crear Page paso 3** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 3.

4. Haz clic en **Crear Page paso 4** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 4.

5. Haz clic en **Crear Page paso 5** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 5.

6. Haz clic en **Crear Page paso 6** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 6.

7. Haz clic en **Crear Page paso 7** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 7.

8. Haz clic en **Crear Page paso 8** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 8.

9. Haz clic en **Crear Page paso 9** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 9.

10. Haz clic en **Crear Page paso 10** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 10.

11. Haz clic en **Crear Page paso 11** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 11.

12. Haz clic en **Crear Page paso 12** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 12.

13. Haz clic en **Crear Page paso 13** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 13.

14. Haz clic en **Crear Page paso 14** → verifica el cambio.
...
1. Haz clic en **Navegación básica paso 1** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 1.

2. Haz clic en **Navegación básica paso 2** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 2.

3. Haz clic en **Navegación básica paso 3** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 3.

4. Haz clic en **Navegación básica paso 4** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 4.

5. Haz clic en **Navegación básica paso 5** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 5.

6. Haz clic en **Navegación básica paso 6** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 6.

7. Haz clic en **Navegación básica paso 7** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 7.

8. Haz clic en **Navegación básica paso 8** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 8.

9. Haz clic en **Navegación básica paso 9** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 9.

10. Haz clic en **Navegación básica paso 10** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 10.

11. Haz clic en **Navegación básica paso 11** → verifica el cambio.

    - Tip: si algo falla, usa *Reload* y repite el paso 11.

12. Haz clic en **Navegación básica paso 12** → verifica el cambio.
...
| r51c1 | r51c2 | r51c3 | r51c4 | r51c5 |
| r52c1 | r52c2 | r52c3 | r52c4 | r52c5 |
| r53c1 | r53c2 | r53c3 | r53c4 | r53c5 |
| r54c1 | r54c2 | r54c3 | r54c4 | r54c5 |
| r55c1 | r55c2 | r55c3 | r55c4 | r55c5 |
| r56c1 | r56c2 | r56c3 | r56c4 | r56c5 |
| r57c1 | r57c2 | r57c3 | r57c4 | r57c5 |
| r58c1 | r58c2 | r58c3 | r58c4 | r58c5 |
| r59c1 | r59c2 | r59c3 | r59c4 | r59c5 |
| r60c1 | r60c2 | r60c3 | r60c4 | r60c5 |
